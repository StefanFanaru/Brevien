...
namespace Blogging.IntegrationTests.ServicesTests
{
  ...
  public class BlogServiceTests : IClassFixture<ServiceTestsFixture>
  {
    ...
    private Blog LastCreatedBlog()
    {
      var sortByCreatedAtDescending = Builders<Blog>.Sort.Descending("CreatedAt");
    ...
    public async Task Blog_is_created_and_returns_200()
    {
      ...
      result.Should().BeOfType(typeof(Blog));
    }
    ...
    public async Task Get_returns_all_user_non_soft_deleted_blogs()
    {
      ...
      var blogs = new List<Blog> {targetBlog};
    ...
    public async Task GetAll_returns_all_non_soft_deleted_blogs_if_admin()
    {
      ...
      var blogs = new List<Blog> {userOneBlog, userTwoBlog};

      // Act
      var result = await blogService.GetAllAsync();
      var objectResult = (OkObjectResult) result.Result;
      var returnedBlogs = (List<Blog>) objectResult.Value;
