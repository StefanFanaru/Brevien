...
namespace Blog.API.Configuration
{
    public static class SwaggerConfiguration
    {
        ...
        public static IServiceCollection AddSwaggerConfiguration(this IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("Blog", GetSwaggerInfo("Blog APIs", "v1", string.Empty));
        ...
        {
            var apiUri = Configuration.GetValue<string>("ApplicationUrls:Blog");
            ...
            {
                options.SwaggerEndpoint($"{pathBase}/swagger/Blog/swagger.json", "Blog APIs");
                options.DocumentTitle = "Blog - Swagger";
                options.OAuthClientId("swagger_ui_blog");
                options.OAuthAppName("Blog - Swagger");
