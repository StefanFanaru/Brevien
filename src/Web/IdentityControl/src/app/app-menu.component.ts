...
//       <li class="nav-item">
//         <a class="nav-link" routerLinkActive="active" routerLink="basics/home"
//           >Home</a
//         >
//       </li>
//       <li class="nav-item">
//         <a class="nav-link" routerLinkActive="active" routerLink="basics/public"
//           >Public</a
//         >
//       </li>
//       <li class="nav-item">
